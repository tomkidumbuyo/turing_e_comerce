...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.pagination = function (page) {
        ...
        this.page = page;
        // get current page
        this.restApi.get('products/' + page + '/' + this.limit).subscribe(function (data) {
            console.log(data);
            _this.products = data.rows;
        });
    };
