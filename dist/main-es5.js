...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.pagination = function (page) {
        ...
        if (this.searchModel && this.searchModel.length > 0 && this.searchModel !== '') {
            ...
            var fp_1 = [];
            this.filtered_products.forEach(function (product) {
                console.log(product.name.toLowerCase().indexOf(_this.searchModel.toLowerCase()));
                if (product.name.toLowerCase().indexOf(_this.searchModel.toLowerCase()) > -1) {
                    fp_1.push(product);
                }
            });
            this.filtered_products = fp_1;
        }
        console.log('searched', this.filtered_products);
